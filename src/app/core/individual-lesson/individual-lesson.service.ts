...
export class IndividualLessonService  {
    ...
    public addComment(id: string, comment: string): Observable<IComment> {
        return this._httpHelper.post(true, this._configService.API.IndividualLesson.comments(id), { comment });
    }
